...
### Jenkins API token
user ID: admin
API Token: d049ff113c5bde043de89836c2978d6c

/var/lib/jenkins
java -jar /opt/jenkins-cli.jar -s http://192.168.33.55:8080/

java -jar /opt/jenkins-cli.jar -s http://192.168.33.55:8080/ login --username admin --password admin
java -jar /opt/jenkins-cli.jar -s http://192.168.33.55:8080/ groovysh